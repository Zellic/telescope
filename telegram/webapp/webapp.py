...
class WebApp:
    ...
    def __init__(self,
        ...
        self.frontend_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "..", 'telescope-webui', 'out')
        self.account_cache = {}
        ...
        self.app = cors(_app, allow_origin=["http://127.0.0.1:8888", "http://localhost:8888",
                                            ...
                                            *(config.get('CORS_POLICY').split(';') if config.get('CORS_POLICY') else [])])
